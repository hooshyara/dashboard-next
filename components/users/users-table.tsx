    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          با کلیک روی دکمه «افزودن کاربر» یک کاربر جدید اضافه کنید.
        </p>
      </div>
    );
  }
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-muted/50 hover:bg-muted/50">
            ...
            <TableHead className="text-right text-foreground">نام کاربری</TableHead>
        ...
        <TableBody>
          {users.map((user) => (
            <TableRow key={user.id} className="hover:bg-muted/30">
              ...
              <TableCell className="text-right text-foreground font-mono text-sm">
                {user.username}
              </TableCell>
              <TableCell className="text-right text-foreground">
                <span dir="ltr" className="inline-block font-mono text-sm">
                  {user.phone}
                </span>
              </TableCell>
