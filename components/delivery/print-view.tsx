...
export function PrintView({ routes }: PrintViewProps) {
  return (
    <div className="print-container hidden print:block bg-white p-8">
      {/* Header */}
      <div className="text-center mb-8 border-b-2 border-black pb-4">
        <h1 className="text-2xl font-bold">لیست ارسال مرسولات</h1>
          ...
          <table className="w-full border-collapse border-2 border-black text-sm">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-black p-2 text-right">شخص تحویل گیرنده</th>
                <th className="border border-black p-2 text-right">زمان تحویل</th>
