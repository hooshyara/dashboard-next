...
import { Pencil, Power, GripVertical, ChevronUp, ChevronDown } from 'lucide-react';
import {
  DndContext,
  closestCenter,
  KeyboardSensor,
...
function SortableRow({ driver, onEdit, onToggleActive, onMoveUp, onMoveDown, isFirst, isLast }: SortableRowProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground mt-2 text-center">
        برای تغییر اولویت، از دکمه‌های بالا/پایین یا کشیدن و رها کردن استفاده کنید
      </p>
    </DndContext>
  );
}
