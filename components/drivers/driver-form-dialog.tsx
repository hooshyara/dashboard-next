            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  >
                    <SelectTrigger dir='rtl' className="bg-secondary border-border text-foreground w-full">
                      <SelectValue placeholder="انتخاب اولویت" />
                    </SelectTrigger>
                    <SelectContent className="bg-card border-border">
                      <SelectItem value="1" className="text-foreground">1 - بالاترین</SelectItem>
                      <SelectItem value="2" className="text-foreground">2 - بالا</SelectItem>
                      <SelectItem value="3" className="text-foreground">3 - متوسط</SelectItem>
                      <SelectItem value="4" className="text-foreground">4 - پایین</SelectItem>
