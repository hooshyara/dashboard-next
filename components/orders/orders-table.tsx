...
const STATUS_COLORS: Record<OrderStatus, string> = {
  ...
  [OrderStatus.CANCEL]: 'bg-destructive/20 text-destructive border-destructive/30',
};
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-muted/50 hover:bg-muted/50">
            ...
            <TableHead className="text-right text-foreground">نوع تخصیص</TableHead>
          ...
          {orders.map((order) => {
            ...
            return (
              <TableRow key={order.id} className="hover:bg-muted/30">
                ...
                <TableCell className="text-foreground">{order.contactPerson}</TableCell>
                ...
                <TableCell className="text-foreground">
                  {displayedDriver ? (
                    ...
                    <span className="text-muted-foreground">تخصیص داده نشده</span>
                  )}
                </TableCell>
                <TableCell>
