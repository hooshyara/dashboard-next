      ...
      <Card className="bg-card border-border">
        <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 w-full sm:w-auto">
            ...
            <Button onClick={handleAddLocation} className="bg-primary text-primary-foreground">
        ...
        <AlertDialogContent className="bg-card border-border">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-muted-foreground">
              آیا مطمئن هستید که می‌خواهید آدرس «{locationToDelete?.title}» را حذف کنید؟ 
              این عمل قابل بازگشت نیست و ممکن است بر سفارشات مرتبط تاثیر بگذارد.
            </AlertDialogDescription>
          </AlertDialogHeader>
