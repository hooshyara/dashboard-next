    ...
    <DashboardLayout title='لیست ارسال'>
      ...
      <div className='grid gap-4 grid-cols-2 sm:grid-cols-3 mb-4 no-print'>
        ...
        <Card className='bg-card border-border'>
          <CardContent className='p-4'>
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-sm '>سفارشات در مسیرها</p>
      ...
      <Card className='bg-card border-border mb-4 no-print'>
        <CardHeader className='flex flex-col md:flex-row md:items-center md:justify-between py-4'>
          <div>
            <CardTitle className='text-foreground col-1'>مسیرهای ارسال</CardTitle>
            <p className='text-sm  mt-1'>سفارشات را با کشیدن و رها کردن بین رانندگان جابجا کنید</p>
          </div>
      ...
      {!loading && ordersInRange.length > 0 && (
        <Card className='bg-card border-border mb-4 no-print'>
          <CardHeader className='py-3 flex justify-between'>
            <div>
              <CardTitle className='text-base text-foreground'>سفارشات تخصیص‌نشده در این بازه</CardTitle>
              <p className='text-sm '>{ordersInRange.length} سفارش</p>
            </div>
          </CardHeader>
      ...
      {loading ? (
        ...
        <Card className='bg-card border-border no-print'>
          <CardContent className='flex flex-col items-center justify-center py-16 text-center'>
            ...
            <p className='text-sm  mt-1'>پس از بهینه‌سازی، مسیرهای ارسال در اینجا نمایش داده می‌شوند.</p>
          </CardContent>
        </Card>
      ) : (
        <DndContext
