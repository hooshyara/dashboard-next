...
import {
  DriversFilter,
  DriversFilterValues,
} from "@/components/drivers/drivers-filter";
...
export default function DriversPage() {
  ...
  async function handleMoveUp(driver: Driver) {
    ...
    [reorderedDrivers[index - 1], reorderedDrivers[index]] = [
      reorderedDrivers[index],
      reorderedDrivers[index - 1],
    ];
  ...
  async function handleMoveDown(driver: Driver) {
    ...
    const reorderedDrivers = [...drivers];
    [reorderedDrivers[index], reorderedDrivers[index + 1]] = [
      reorderedDrivers[index + 1],
      reorderedDrivers[index],
    ];
